...
[![Build Status](https://travis-ci.org/MGallow/shrink.svg?branch=master)](https://travis-ci.org/MGallow/shrink)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/shrink)](https://cran.r-project.org/package=shrink)

## Overview

`shrink` is an implementation of the methods described in "Shrinking Characteristics of Precision Matrix Estimators" [pdf](https://arxiv.org/pdf/1704.04820.pdf). It estimates a penalized precision matrix via a modified alternating direction method of multipliers (ADMM) algorithm.
...
If there are any issues/bugs, please let me know: [github](https://github.com/MGallow/shrink/issues). You can also contact me via my [website](https://mgallow.github.io/). Pull requests are welcome!

...
// ADMMc
List ADMMc(const arma::mat& S, const arma::mat& A, const arma::mat& B, const arma::mat& C, const arma::mat& initOmega, const arma::mat& initZ2, const arma::mat& initY, const double lam, const double tau, double rho, const double mu, const double tau_rho, const int iter_rho, std::string crit, const double tol_abs, const double tol_rel, const int maxit);
RcppExport SEXP _SCPME_ADMMc(SEXP SSEXP, SEXP ASEXP, SEXP BSEXP, SEXP CSEXP, SEXP initOmegaSEXP, SEXP initZ2SEXP, SEXP initYSEXP, SEXP lamSEXP, SEXP tauSEXP, SEXP rhoSEXP, SEXP muSEXP, SEXP tau_rhoSEXP, SEXP iter_rhoSEXP, SEXP critSEXP, SEXP tol_absSEXP, SEXP tol_relSEXP, SEXP maxitSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat& >::type S(SSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(ADMMc(S, A, B, C, initOmega, initZ2, initY, lam, tau, rho, mu, tau_rho, iter_rho, crit, tol_abs, tol_rel, maxit));
    return rcpp_result_gen;
END_RCPP
}
// CV_ADMMc
List CV_ADMMc(const arma::mat& X, const arma::mat& S, const arma::mat& Y, const arma::mat& A, const arma::mat& B, const arma::mat& C, const arma::colvec& lam, bool path, double tau, double rho, const double mu, const double tau_rho, const int iter_rho, std::string crit, const double tol_abs, const double tol_rel, int maxit, int adjmaxit, int K, std::string crit_cv, std::string start, std::string trace);
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(CV_ADMMc(X, S, Y, A, B, C, lam, path, tau, rho, mu, tau_rho, iter_rho, crit, tol_abs, tol_rel, maxit, adjmaxit, K, crit_cv, start, trace));
    return rcpp_result_gen;
END_RCPP
}
// CVP_ADMMc
arma::mat CVP_ADMMc(const arma::mat& X_train, const arma::mat& X_valid, const arma::mat& Y_train, const arma::mat& Y_valid, const arma::mat& A, const arma::mat& B, const arma::mat& C, const arma::colvec& lam, const double tau, double rho, const double mu, const double tau_rho, const int iter_rho, std::string crit, const double tol_abs, const double tol_rel, int maxit, int adjmaxit, std::string crit_cv, std::string start, std::string trace);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::string >::type start(startSEXP);
    Rcpp::traits::input_parameter< std::string >::type trace(traceSEXP);
    rcpp_result_gen = Rcpp::wrap(CVP_ADMMc(X_train, X_valid, Y_train, Y_valid, A, B, C, lam, tau, rho, mu, tau_rho, iter_rho, crit, tol_abs, tol_rel, maxit, adjmaxit, crit_cv, start, trace));
    return rcpp_result_gen;
END_RCPP
}
